<template>
  <div class="bg-white">
    <div class="mx-auto">
      <div class="relative isolate overflow-hidden bg-gray_900 px-6 pt-16 shadow-2xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
        ...
        <div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
          <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">Gracias por tomar el tiempo.</h2>
          <p class="mt-6 text-lg leading-8 text-gray_300">Demo App hecha con Tailwind, Vue2 y Nuxt2.</p>
        </div>
